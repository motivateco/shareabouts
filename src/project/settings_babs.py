...
SHAREABOUTS_DATASET_KEY = "ZGVlNzI3ZjEzODA3ZjQxYWJiMzE4NzY0"
SHAREABOUTS_DATASET_ROOT = "http://shareaboutsapi.poepublic.com/api/v2/fkh/datasets/babs"
SHAREABOUTS_FLAVOR = "babs"
...
LOCAL_SETTINGS_FILE = os.path.join(os.path.dirname(__file__), 'local_settings_hubway.py')
